...
public class DirBrowserFragment extends Fragment {
    ...
    public void onCreate(@Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        isAtRoot = true;
        savedPaths = new HashSet<>(PreferenceManager.getDefaultSharedPreferences(requireContext()).getStringSet(OpenMusicApp.PREFS_KEY_LIBRARY_PATHS, OpenMusicApp.defaultPathsSet));
