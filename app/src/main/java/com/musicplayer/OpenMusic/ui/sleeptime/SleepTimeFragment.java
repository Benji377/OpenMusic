...
public class SleepTimeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable @org.jetbrains.annotations.Nullable ViewGroup container, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        updateTimePicker();
        switchCompat.setChecked(preferences.getBoolean(OpenMusicApp.PREFS_KEY_TIMEPICKER_SWITCH, false));
    ...
    public void updateTimePicker() {
        ...
        int timee = preferences.getInt(OpenMusicApp.PREFS_KEY_TIMEPICKER, 36480);
        int min = (timee / 60) % 60;
